 ...
 * Same implementation as admin portal for consistency
 */
...
class LocationService {
  ...
  async getAddressFromCoordinates(latitude, longitude) {
    return this.getPincodeFromCoordinates(latitude, longitude);
  }
}

// Export singleton instance
export const geocodingService = new LocationService();
